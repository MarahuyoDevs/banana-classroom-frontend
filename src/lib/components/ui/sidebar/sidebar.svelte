...
<aside
	class="hidden min-h-screen w-fit flex-col items-center justify-between rounded-l-md border bg-black p-4 md:flex"
>
		...
		<ul class="pt-4">
			{#if userType === 'student'}
				<li>
					<Tooltip.Root>
						<Tooltip.Trigger asChild let:builder>
							<Button builders={[builder]} href="/home" variant="ghost">
								<svg
									width="15"
									height="15"
									viewBox="0 0 15 15"
				...
				<li>
					<Tooltip.Root>
						<Tooltip.Trigger asChild let:builder>
							<Button builders={[builder]} href="/classrooms/join" variant="ghost">
								<svg
									width="15"
									height="15"
									viewBox="0 0 15 15"
				...
				<li>
					<Tooltip.Root>
						<Tooltip.Trigger asChild let:builder>
							<Button builders={[builder]} href="/classrooms" variant="ghost">
								<svg
									width="15"
									height="15"
									viewBox="0 0 15 15"
				...
				<li>
					<Tooltip.Root>
						<Tooltip.Trigger asChild let:builder>
							<Button builders={[builder]} href="/quiz" variant="ghost">
								<svg
									width="15"
									height="15"
									viewBox="0 0 15 15"
				...
				<li>
					<Tooltip.Root>
						<Tooltip.Trigger asChild let:builder>
							<Button builders={[builder]} href="/results" variant="ghost">
								<svg
									width="15"
									height="15"
									viewBox="0 0 15 15"
			...
			{:else if userType === 'instructor'}
				...
				<li>
					<Tooltip.Root>
						<Tooltip.Trigger asChild let:builder>
							<Button builders={[builder]} href="/classrooms/create" variant="ghost">
								<svg
									width="15"
									height="15"
									viewBox="0 0 15 15"
